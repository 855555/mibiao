...
// 执行查询操作
$sql = "SELECT yuming, beizhu, jiage, pingtai, link FROM mi WHERE zhuangtai = '未售'"; // 添加WHERE条件来筛选未售数据
            ...
            <div class="col-6 col-md-3 misbox">
								<div class="acard">
									...
									<div class="acard-footer">
										...
										<div class="acard-button">
											<!-- 可加链接跳转 -->
											<a href="' . $row["link"] . '" target="_blank" style="height: 20px;display: flex;">
